...
st.set_page_config(page_title="PDF Learning Assistant", page_icon="🚀", layout="wide")
...
if st.session_state.error_message and not st.session_state.quiz:
    st.error(st.session_state.error_message)

st.sidebar.header("About")
st.sidebar.info(
    "This is the PDF Learning Assistant, a project using the `openai-agents` SDK. "
